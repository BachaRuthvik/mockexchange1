...
def detect_flash_loan_pattern(
    ...
    """
    if len(recent_benchmarks) < reversion_window + 2:
        return False

    # last 3 points [t-2, t-1, t]
    ...
    # Now check reversion in the next few points (in this offline demo,
    # we approximate by checking that prev was closer to baseline than current)
    # In a live engine, you'd track future steps too.
...
def run_demo():
    ...
    print("\nDone. You can now port this logic into notebooks or hook it into Grafana/Prometheus.")
